                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-4 border border-slate-200 dark:border-slate-700 rounded-lg hover:border-slate-300 dark:hover:border-slate-600 transition-colors">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <a href="series_oauth.php?provider=google&action=disconnect" class="text-slate-400 dark:text-slate-500 hover:text-red-600 dark:hover:text-red-400 text-sm font-medium transition-colors">
                                        <i class="fas fa-unlink"></i>
                                    </a>
                                </div>
                                <?php else: ?>
                                <a href="series_oauth.php?provider=google&action=connect" class="bg-slate-100 dark:bg-slate-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 text-slate-700 dark:text-slate-300 hover:text-white px-6 py-2 rounded-lg text-sm font-medium transition-all">
                                    Connect
                                </a>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-4 border border-slate-200 dark:border-slate-700 rounded-lg hover:border-slate-300 dark:hover:border-slate-600 transition-colors">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <a href="series_oauth.php?provider=github&action=disconnect" class="text-slate-400 dark:text-slate-500 hover:text-red-600 dark:hover:text-red-400 text-sm font-medium transition-colors">
                                        <i class="fas fa-unlink"></i>
                                    </a>
                                </div>
                                <?php else: ?>
                                <a href="series_oauth.php?provider=github&action=connect" class="bg-slate-100 dark:bg-slate-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 text-slate-700 dark:text-slate-300 hover:text-white px-6 py-2 rounded-lg text-sm font-medium transition-all">
                                    Connect
                                </a>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-4 border border-slate-200 dark:border-slate-700 rounded-lg hover:border-slate-300 dark:hover:border-slate-600 transition-colors">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <a href="series_oauth.php?provider=spotify&action=disconnect" class="text-slate-400 dark:text-slate-500 hover:text-red-600 dark:hover:text-red-400 text-sm font-medium transition-colors">
                                        <i class="fas fa-unlink"></i>
                                    </a>
                                </div>
                                <?php else: ?>
                                <a href="series_oauth.php?provider=spotify&action=connect" class="bg-slate-100 dark:bg-slate-700 hover:bg-indigo-600 dark:hover:bg-indigo-600 text-slate-700 dark:text-slate-300 hover:text-white px-6 py-2 rounded-lg text-sm font-medium transition-all">
                                    Connect
                                </a>
                                <?php endif; ?>
                            </div>
    ...
    <script>
        ...
        async function handleAvatarUpload(event) {
            ...
            try {
                ...
                const response = await fetch('series_api_avatar.php?action=upload', {
                    method: 'POST',
                    body: formData
                });
        ...
        async function selectAvatar(avatarUrl) {
            try {
                const response = await fetch('series_api_avatar.php?action=set', {
                    method: 'POST',
