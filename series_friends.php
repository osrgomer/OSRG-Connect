...
?>
    ...
    <script>
        ...
        async function loadFriends() {
            try {
                const response = await fetch('series_api_users.php?action=get_friends');
        ...
        async function loadRequests() {
            try {
                const response = await fetch('series_api_users.php?action=get_requests');
                const data = await response.json();
                if (data.success) {
        ...
        document.getElementById('searchInput').addEventListener('input', (e) => {
            ...
            searchTimeout = setTimeout(async () => {
                try {
                    const response = await fetch(`series_api_users.php?action=search_users&q=${encodeURIComponent(query)}`);
        ...
        window.sendRequest = async (userId) => {
            try {
                const response = await fetch('series_api_users.php?action=add_friend', {
                    method: 'POST',
        ...
        window.removeFriend = async (userId) => {
            ...
            try {
                const response = await fetch('series_api_users.php?action=remove_friend', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({ friend_id: userId })
                });
