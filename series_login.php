...
<body class="min-h-screen bg-slate-50 flex flex-col items-center justify-center p-4">
    ...
    <div id="authContainer" class="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border border-slate-200">
        <div id="loginForm">
            ...
            <div class="mt-6 text-center text-sm">
                ...
                <a href="series_register.php" class="text-indigo-600 hover:text-indigo-700 font-bold ml-1">Create account</a>
            </div>
        </div>
    ...
    <a href="series_index.php" class="mt-8 text-slate-600 hover:text-slate-800 text-sm transition-colors flex items-center gap-2">
