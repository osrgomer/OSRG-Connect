    ...
    <header class="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 <?php echo isset($_SESSION['admin_origin']) ? 'mt-10' : ''; ?> sticky top-0 z-30 shadow-sm">
        <div class="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <nav class="hidden md:flex items-center gap-1">
                ...
                <a href="admin.php" class="px-3 py-2 text-sm font-medium <?php echo ($current_page ?? '') === 'admin' ? 'text-red-600 bg-red-50 dark:bg-red-900/30' : 'text-slate-600 dark:text-slate-300 hover:text-red-600 dark:hover:text-red-400 hover:bg-slate-50 dark:hover:bg-slate-700'; ?> rounded-lg transition-colors">
            ...
            <div class="flex items-center gap-2">
                ...
                <div class="md:hidden relative">
                    ...
                    <div id="mobileMenu" class="hidden absolute right-0 top-12 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg shadow-lg py-2 min-w-[120px]">
                        ...
                        <?php if ((isset($_SESSION['user_email']) && $_SESSION['user_email'] === 'omersr12@gmail.com') || isset($_SESSION['admin_origin'])): ?>
                        <a href="admin.php" class="block px-4 py-2 text-sm font-medium <?php echo ($current_page ?? '') === 'admin' ? 'text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/30' : 'text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700'; ?>">
                            <i class="fas fa-shield-alt mr-1"></i>Admin
                        </a>
                        <?php endif; ?>
