...
To enable real OAuth connections, you need to set up applications with each provider and update the credentials in `series_oauth.php`.
...
6. Add authorized redirect URI: `http://localhost/serieslist/series_oauth.php?provider=google`
...
3. Fill in:
   ...
   - Authorization callback URL: `http://localhost/serieslist/series_oauth.php?provider=github`
...
2. Create a new app
3. In app settings, add redirect URI: `http://localhost/serieslist/series_oauth.php?provider=spotify`
4. Copy the Client ID and Client Secret

## 4. Update series_oauth.php

Replace the placeholder values in `series_oauth.php`:
...
- The `series_oauth.php` file redirect_uri values

Change from:
`http://localhost/serieslist/series_oauth.php?provider=PROVIDER`

To your actual domain:
`https://yourdomain.com/series_oauth.php?provider=PROVIDER`
