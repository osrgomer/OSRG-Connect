...
function loadNinjaSprites() {
    for(let i = 0; i < 10; i++) {
        ...
        runImg.src = `sp_assets/ninja/png/Run__00${i}.png`;
        ninjaSprites.run.push(runImg);
        
        const jumpImg = new Image();
        jumpImg.src = `sp_assets/ninja/png/Jump__00${i}.png`;
        ninjaSprites.jump.push(jumpImg);
        
        const deadImg = new Image();
        deadImg.src = `sp_assets/ninja/png/Dead__00${i}.png`;
        ninjaSprites.dead.push(deadImg);
        
        const slideImg = new Image();
        slideImg.src = `sp_assets/ninja/png/Slide__00${i}.png`;
